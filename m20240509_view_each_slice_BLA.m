...
% Import atlas
addpath('/Users/jstrohl/Data/PET - ATLAS-MICE 2')
MRI_atlas = niftiread('2011-10-30_MRI-template3.hdr', ...
    '2011-10-30_MRI-template3.img');

% Import PET scan file
file = '/Users/jstrohl/Data/20240216 Sepsis Fear PET data/20240216 preprocessed nifti files/03 CLP familiarization/srr20190805_E0681_FDG_hab_dcXbb.nii';
PET_scan = niftiread(file);

% Save images
save_imgs = 0;

% Save image folder
save_folder = '/Users/jstrohl/Desktop/20231108 Strohl Sepsis fear network/20240514 Fig 2 images/20240529 E0681 LS';
group_name = 'F3';
...
% Create variable to store PET data after the masks have been applied
...
for islice = 1:size(regions,1)
    ...
    masked_PET_bilateral = masked_PET{islice,1} + masked_PET{islice,2};
    ...
    figure
    imshow(masked_PET_bilateral,[],Colormap=jet,DisplayRange=[0.6,1.1])
